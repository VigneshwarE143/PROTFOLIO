...
const personalData = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1gnJeF7mga7jmCGdw5aeFHEk-PYd5WaHK/view?usp=drivesdk",
  ...
  skills: [
    ...
    {
      category: "Frontend",
      list: ["React.js", "JavaScript/TypeScript", "HTML5/CSS3", "Tailwind CSS"],
    },
    {
      category: "Databases & Tools",
      list: ["PostgreSQL", "MySQL", "MongoDB", "Git/GitHub", "Docker"],
    },
    {
      category: "Data & AI",
      list: ["Python", "Machine Learning", "Data Analysis", "Pandas/NumPy"],
    },
  ],
  ...
  projects: [
    {
      ...
      description:
        "Developed a scalable, full-featured e-commerce catalog backend. Features include product management, secure authentication (JWT), and advanced searching.",
    ...
    },
    {
      ...
      description:
        "Designed and implemented a robust job board platform backend, facilitating real-time job postings and applicant tracking using modern Spring architecture.",
    ...
    },
    {
      ...
      description:
        "Built a student management system to manage student profiles, course enrollments, and academic records with clean CRUD workflows.",
      tech: ["Java", "Spring Boot", "MySQL", "REST APIs"],
      link: "https://github.com/VigneshwarE143/student-management-system",
      icon: Briefcase,
    },
  ],
  ...
  education: [
    ...
    },
    {
      ...
      institution: "S M Hindu Hr Sec School, Sirkali",
      details: "Percentage: 72.83%",
      year: "2019-2020",
    },
    {
      type: "SSLC (10th Grade)",
      institution: "S M Hindu Hr Sec School, Sirkali",
...
const App = () => {
  ...
  const MobileNavbar = () => (
    <header className="fixed top-0 left-0 right-0 z-50 md:hidden bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg border-b border-gray-100 dark:border-gray-800">
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? "max-h-96 opacity-100 p-4" : "max-h-0 opacity-0"}`}
      >
      ...
      <div className="max-w-4xl mx-auto p-8 text-center">
        ...
        <div className="mx-auto mb-6 w-52 h-52 rounded-full bg-white p-1 shadow-xl relative">
          <div className="w-full h-full rounded-full overflow-hidden">
            <img
              ...
              onError={(e) => {
                ...
                e.target.src =
                  "https://placehold.co/220x220/4b5563/ffffff?text=V.E";
              }}
            />
          </div>
          ...
          <span
            ...
            style={{
              boxShadow:
                "0 0 0 4px rgba(255,255,255,0.5), 0 6px 18px rgba(2,6,23,0.2)",
            }}
          />
        </div>
    ...
    >
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mt-6 space-y-6 text-lg text-gray-700 dark:text-gray-300">
          <p>
            I approach development with a strong focus on clean code and robust
            architecture. My background in AI and Data Science provides a unique
            edge, allowing me to build not only functional applications but also
            data-informed features and scalable backend systems.
          </p>
          <p>
            I excel in the **Java Spring Boot ecosystem**, designing and
            implementing RESTful APIs for microservices. On the frontend, I
            utilize **React and Tailwind CSS** to create modern, responsive, and
            highly accessible user interfaces.
          </p>
          <p>
            I'm eager to contribute to projects that push the boundaries of
            technology and offer opportunities to integrate data-driven insights
            into core product functionality.
          </p>
        </div>
      </div>
    </section>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tech.map((tag, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 text-sm font-medium rounded-full bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-300"
                  >
                    {tag}
                  </span>
                ))}
